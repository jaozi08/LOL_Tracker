...
def export_all_ics(events, base_dir):
    lck_dir = os.path.join(base_dir, "lck")
    ...
    save_ics(os.path.join(lck_dir, "lck.ics"), events, "LCK schedule", False)
    save_ics(os.path.join(lck_dir, "lck-alarm.ics"), events, "LCK schedule(w/ alarm)", True)
...
if __name__ == "__main__":
    ...
    print(f"Done! ics files created in: {os.path.join(target_folder, 'lck')}")
